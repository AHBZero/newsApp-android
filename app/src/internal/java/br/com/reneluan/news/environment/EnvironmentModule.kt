...
import br.com.reneluan.news.network.HttpInterceptor
...
class EnvironmentModule(val app: App) {
    ...
    fun provideOkHttpClient(@ForApplication app: Context,
                            ...
                            @OkHttpNetworkInterceptors @NonNull networkInterceptors: Array<Interceptor>,
                            httpInterceptor: HttpInterceptor): OkHttpClient {
